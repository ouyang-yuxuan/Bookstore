    ...
    <!--start-login-form-->
				<div class="main">
			    	<div class="login-head">
					    <h1 style="color:#969547;">Elegant Updata forms</h1>
					</div>
					<div  class="wrap">
						  <div class="Regisration" style="background:#4D3315">
						  	...
						  	<form action="/Bookstore/UpdataUser" method="post" name="myform">
								...
								<div class="submit">
									<input type="button" onclick="repass(this.form)" value="Submit >" >
								</div>
									<div class="clear"> </div>
